...
/*
//Better way to create a Map manually
...
const checkMiddleSeat = function (seat) {
  ...
  if (s === 'B' || s === 'E') console.log('You have the middle');
...
document.querySelector('button').addEventListener('click', function () {
  ...
  for (const [i, words] of lines.entries()) {
    ...
    const first = lowered.slice(0, lowered.indexOf('_')).trim();
    const second = lowered.slice(lowered.indexOf('_') + 1);
